    ...
    <nav id="topbar">
        ...
        <ul class="list-unstyled menu-categories" id="topAccordion">
            ...
            <li class="menu single-menu active">
                <a href="{{route('index')}}" aria-expanded="true" class="dropdown-toggle">
                    <div class="">
            ...
            {{-- </li>--}}
            <li class="menu single-menu">
                <a href="{{route('sessions.index')}}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu single-menu">
                <a href="{{route('types.index')}}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus-circle">
                            <circle cx="12" cy="12" r="10"></circle>
                            <line x1="12" y1="8" x2="12" y2="16"></line>
            ...
            <li class="menu single-menu">
                ...
                <ul class="collapse submenu list-unstyled" id="dashboard" data-parent="#topAccordion">
                    <li class="active">
                        <a href="{{route('member-types.index')}}">Types</a>
                    </li>
                    <li>
